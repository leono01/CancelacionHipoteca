...
import com.gisnet.cancelacion.persistance.services.EntidadPersistanceService;
 ...
 * @author marco-g8
 */
public class EntidadServiceHandler implements EntidadService {

    @Autowired
    private EntidadPersistanceService service;
